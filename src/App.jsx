    ...
    <Router>
      <nav className="bg-white shadow px-6 py-4 mb-6 flex justify-between">
        <ul className="flex space-x-6 text-gray-700">
          ...
          <li><Link to="/fund-management" className="hover:text-blue-600">资金管理</Link></li>
      ...
      <div className="bg-gray-100 min-h-screen">
        <Routes>
          ...
          {/* ✅ 新增 FundManagement 受保护页面 */}
          <Route path="/fund-management" element={<RequireAuth><FundManagementPage /></RequireAuth>} />
        </Routes>
      </div>
    </Router>
  );
